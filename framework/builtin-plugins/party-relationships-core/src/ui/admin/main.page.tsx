...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Party Control Room"),
    React.createElement("p", null, "Canonical parties, contacts, and relationship facets with merge-safe business identity tracking."),
    React.createElement(
      "p",
      null,
