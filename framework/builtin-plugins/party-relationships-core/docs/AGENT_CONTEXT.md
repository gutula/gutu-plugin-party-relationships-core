# Party & Relationships Core Agent Context
...
- Package root: `framework/builtin-plugins/party-relationships-core`
- Service layer: `framework/builtin-plugins/party-relationships-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/party-relationships-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/party-relationships-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/party-relationships-core/src/ui`

## Safe assumptions

- Use `party-relationships-core` as the stable plugin identifier and `@plugins/party-relationships-core` as the package import name.
