...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/party-relationships-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-party-relationships-core:");
...
console.log("Documentation check passed for gutu-plugin-party-relationships-core.");
